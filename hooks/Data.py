...
def after_load_location_file(location_table: list) -> list:
    ...
    starter_locations = [
        ...
        "Unlock Retainers",
        "Complete Main Story Quest: The ______ Envoy",
        ...
        "Earn 1,000 MGP",
        "Catch One Prize in the Claw Game",
        "Win a Chocobo Race",
        "Buy a Scratch Ticket",
        "Play a Match of Triple Triad",
        "Participate in Your First GATE"
    ]
